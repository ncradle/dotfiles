# Generated by Powerlevel10k configuration wizard on 2021-12-11 at 15:06 JST.
...
() {
  ...
  #################################[ user: username ]##################################
  typeset -g POWERLEVEL9K_USER_DEFAULT_FOREGROUND=81
  ...
  function my_git_formatter() {
    ...
    local conflicted='%196' # red foreground
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=87
